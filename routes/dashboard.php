...
Route::middleware(['auth', 'role:super-admin|admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('/transactions/{id}/invoice', [InvoiceController::class, 'download'])->name('transactions.invoice.download');
    Route::get('/transactions/{id}/invoice/view', [InvoiceController::class, 'view'])->name('transactions.invoice.view');
});
