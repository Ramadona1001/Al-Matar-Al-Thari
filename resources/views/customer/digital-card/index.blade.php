        ...
        <div class="col-lg-10 col-xl-8">
            ...
            <div class="card shadow-lg border-0 mb-4" style="border-radius: 20px; overflow: hidden;">
                ...
                <div class="business-card"
                    style="background: linear-gradient(135deg, #ffffff 0%, #f8f9fa 100%); padding: 40px; min-height: 400px; position: relative;">
                    <!-- Logo at Top -->
                        ...
                        <div class="col-md-5 text-center">
                            @if ($digitalCard->qr_code)
                                ...
                                <div class="qr-code-container"
                                    style="background: white; padding: 20px; border-radius: 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.1); display: inline-block;">
                                ...
                                <p class="text-muted mt-3 mb-0" style="font-size: 0.9rem;">
                                    {{ __('Scan this QR code at the store') }}</p>
                            @else
                                <div class="qr-code-placeholder"
                                    style="background: #f0f0f0; width: 180px; height: 180px; border-radius: 15px; display: inline-flex; align-items: center; justify-content: center;">
                            ...
                            <div class="customer-info" style="color: #3D4F60;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="mb-4">
                                        ...
                                        <p style="color: #6c757d; font-size: 1rem; margin: 0;">{{ __('Loyalty Member') }}
                                        </p>
                                    </div>
                                ...
                                <div class="card-details"
                                    style="background: rgba(61, 79, 96, 0.05); padding: 20px; border-radius: 12px; margin-bottom: 20px;">
                                    <div class="mb-3">
                                        <div
                                            style="color: #6c757d; font-size: 0.85rem; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px;">
                                            {{ __('Card Number') }}
                                        </div>
                                        <div
                                            style="color: #3D4F60; font-size: 1.5rem; font-weight: 700; font-family: 'Courier New', monospace;">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div>
                                                @if ($digitalCard->isActive())
                                                    <span class="badge"
                                                        style="background: #28a745; color: white; padding: 6px 12px; border-radius: 6px; font-weight: 600;">
                                                        {{ __('Active') }}
                                                    </span>
                                                @else
                                                    <span class="badge"
                                                        style="background: #dc3545; color: white; padding: 6px 12px; border-radius: 6px; font-weight: 600;">
                                                        {{ __('Inactive') }}
                                                    </span>
                                                @endif
                                            </div>
                    ...
                    <!-- Decorative Element -->
                    <div
                        style="position: absolute; bottom: 0; left: 0; right: 0; height: 4px; background: linear-gradient(90deg, #3b82f6 0%, #2563eb 50%, #1e40af 100%);">
                    </div>
                </div>
            </div>
