                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('customer.transactions.invoice.download', $transaction->id) }}" class="btn btn-sm btn-outline-primary" title="{{ __('Download Invoice') }}">
                                        <i class="fas fa-download"></i>
                                    </a>
                                    <a href="{{ route('customer.transactions.invoice.view', $transaction->id) }}" target="_blank" class="btn btn-sm btn-outline-info" title="{{ __('View Invoice') }}">
