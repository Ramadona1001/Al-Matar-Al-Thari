    ...
    <div class="card-body px-4 pb-4">
            ...
            <div class="mb-4">
                ...
                <div>
                    <img src="{{ asset('storage/' . $banner->image_path) }}" 
                         alt="{{ $banner->translate('en')->title ?? __('Banner') }}" 
                         class="img-thumbnail" 
        ...
        <form method="POST" action="{{ route('admin.banners.update', $banner) }}" enctype="multipart/form-data">
            ...
            <div class="tab-content mb-4" id="langTabsContent">
                @foreach($locales as $index => $locale)
                    @php
                        $translation = $banner->translate($locale);
                    @endphp
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                ...
                                <input type="text" 
                                       name="title[{{ $locale }}]" 
                                       id="title_{{ $locale }}" 
                                       value="{{ old("title.{$locale}", $translation->title ?? '') }}" 
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" 
                                       ...
                                       id="subtitle_{{ $locale }}" 
                                       value="{{ old("subtitle.{$locale}", $translation->subtitle ?? '') }}" 
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description[{{ $locale }}]" 
                                          ...
                                          placeholder="{{ __('Enter description in :locale', ['locale' => strtoupper($locale)]) }}">{{ old("description.{$locale}", $translation->description ?? '') }}</textarea>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old("button_text.{$locale}", $translation->button_text ?? '') }}" 
