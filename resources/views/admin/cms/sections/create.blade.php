    ...
    <div class="card-header bg-white border-0 pb-0 pt-4 px-4">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <h5 class="fw-bold mb-0 text-gray-900">{{ __('Create Section') }}</h5>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-6">
                    ...
                    <select name="page" 
                        ...
                        @foreach($pages ?? [] as $page)
                            <option value="{{ $page }}" {{ old('page') == $page ? 'selected' : '' }}>{{ ucfirst($page) }}</option>
                        @endforeach
                    </select>
                    @error('page')
                        <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="content[{{ $locale }}]" 
                                          id="content_{{ $locale }}" 
                                          rows="8" 
                                          class="form-control @error("content.{$locale}") is-invalid @enderror">{{ old("content.{$locale}") }}</textarea>
            ...
            <div class="row g-4 mt-4 pt-4 border-top">
                ...
                <div class="col-md-6">
                    ...
                    <select name="columns_per_row" 
                        ...
                        <option value="1" {{ old('columns_per_row', 1) == 1 ? 'selected' : '' }}>{{ __('1 Column (Full Width)') }}</option>
                        <option value="2" {{ old('columns_per_row', 1) == 2 ? 'selected' : '' }}>{{ __('2 Columns') }}</option>
                        <option value="3" {{ old('columns_per_row', 1) == 3 ? 'selected' : '' }}>{{ __('3 Columns') }}</option>
                        <option value="4" {{ old('columns_per_row', 1) == 4 ? 'selected' : '' }}>{{ __('4 Columns') }}</option>
                    </select>
