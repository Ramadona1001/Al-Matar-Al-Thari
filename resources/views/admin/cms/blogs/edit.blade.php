    ...
    <div class="card-header bg-white border-0 pb-0 pt-4 px-4">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                ...
                <h5 class="fw-bold mb-0 text-gray-900">{{ __('Edit Blog Post') }}</h5>
            </div>
        </div>
    </div>
    <div class="card-body px-4 pb-4">
        @if($blog->featured_image)
            <div class="mb-4">
                ...
                <div>
                    <img src="{{ asset('storage/' . $blog->featured_image) }}" alt="Featured Image" class="img-thumbnail" style="max-height: 200px; max-width: 100%;">
                </div>
            </div>
        @endif
        ...
        @if($blog->og_image)
            <div class="mb-4">
                ...
                <div>
                    <img src="{{ asset('storage/' . $blog->og_image) }}" alt="OG Image" class="img-thumbnail" style="max-height: 200px; max-width: 100%;">
                </div>
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('admin.blogs.update', $blog) }}" enctype="multipart/form-data">
            ...
            <div class="tab-content mb-4" id="languageTabsContent">
                @foreach($locales as $index => $locale)
                    @php
                        ...
                        $excerptValue = old("excerpt.{$locale}", $translation ? $translation->excerpt : '');
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="excerpt[{{ $locale }}]" 
                                          id="excerpt_{{ $locale }}" 
                                          rows="3" 
                                          class="form-control @error("excerpt.{$locale}") is-invalid @enderror">{{ $excerptValue }}</textarea>
            ...
            <div class="d-flex justify-content-end gap-2 mt-4 pt-4 border-top">
                ...
                <button type="submit" class="btn btn-primary btn-animated">
                    <i class="fas fa-save me-2"></i>{{ __('Update Blog Post') }}
                </button>
            </div>
        </form>
    </div>
