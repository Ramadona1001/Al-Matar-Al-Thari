                        ...
                        <div class="tab-pane fade show active" id="lang-en" role="tabpanel" aria-labelledby="lang-en-tab">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                          ...
                                          placeholder="{{ __('Enter company description in English') }}">{{ old('description_en') }}</textarea>
                        ...
                        <div class="tab-pane fade" id="lang-ar" role="tabpanel" aria-labelledby="lang-ar-tab">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                          ...
                                          placeholder="{{ __('Enter company description in Arabic') }}">{{ old('description_ar') }}</textarea>
