                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_en') is-invalid @enderror" 
                                           id="name_en" name="name_en" value="{{ old('name_en', $category->name['en'] ?? '') }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                              ...
                                              placeholder="{{ __('Enter category description in English') }}">{{ old('description_en', $category->description['en'] ?? '') }}</textarea>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name_ar') is-invalid @enderror" 
                                           id="name_ar" name="name_ar" value="{{ old('name_ar', $category->name['ar'] ?? '') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description_ar') is-invalid @enderror" 
                                              ...
                                              placeholder="{{ __('Enter category description in Arabic') }}">{{ old('description_ar', $category->description['ar'] ?? '') }}</textarea>
